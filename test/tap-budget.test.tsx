...
/**
 * `FoodRow` is the stored row plus its derived serving (issue #86) — `withServing` computes the
 * derived half (`kcalPerServing`/`proteinPerServing`/`servingGrams`/`servingMl`) from the stored
 * per-100 numbers the same way every real query does, rather than hand-writing a second copy of
 * that arithmetic here that could drift from it.
 */
