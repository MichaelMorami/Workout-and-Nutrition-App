...
### `app/(tabs)/index.tsx`  <sub>81 lines</sub>
...
### `src/components/quick-add/index.ts`  <sub>4 lines</sub>
...
<sub>used by: `app/(tabs)/index.tsx`, `src/components/quick-add/QuickAddGrid.tsx`, `src/components/today/WeightChip.tsx`</sub>
...
<sub>used by: `src/components/quick-add/PortionSheet.tsx`, `src/components/quick-add/QuickAddTile.tsx`</sub>

### `src/hooks/useTheme.ts`  <sub>14 lines</sub>

- `function useTheme(): Theme`

<sub>used by: `app/(tabs)/_layout.tsx`, `app/(tabs)/index.tsx`, `app/_layout.tsx`, `src/components/quick-add/QuickAddGrid.tsx`, `src/components/today/WeightChip.tsx`</sub>
