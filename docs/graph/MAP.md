...
### `app/(tabs)/index.tsx`  <sub>113 lines</sub>
...
### `src/components/quick-add/PortionSheet.tsx`  <sub>485 lines</sub>

- `function PortionSheet({ candidate, theme, locale, onLog, onClose, testID = 'portion-sheet' }: PortionSheetProps): import("react").JSX.Element | null`
...
<sub>used by: `app/(tabs)/index.tsx`, `src/components/quick-add/QuickAddGrid.tsx`, `src/components/quick-add/UndoToast.tsx`, `src/components/today/WeightChip.tsx`</sub>
...
<sub>used by: `app/(tabs)/_layout.tsx`, `app/(tabs)/index.tsx`, `app/_layout.tsx`, `src/components/quick-add/QuickAddGrid.tsx`, `src/components/quick-add/UndoToast.tsx`, `src/components/today/WeightChip.tsx`</sub>
...
<sub>used by: `src/components/quick-add/QuickAddGrid.tsx`, `src/components/quick-add/UndoToast.tsx`</sub>
...
<sub>used by: `app/(tabs)/index.tsx`, `src/components/quick-add/QuickAddGrid.tsx`, `src/components/quick-add/UndoToast.tsx`</sub>
