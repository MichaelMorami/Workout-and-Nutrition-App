...
### `app/(tabs)/index.tsx`  <sub>128 lines</sub>
...
<sub>used by: `app/foods/[id].tsx`, `app/foods/new.tsx`, `src/components/meals/MealForm.tsx`</sub>
...
<sub>used by: `app/(tabs)/index.tsx`, `app/foods/[id].tsx`, `app/foods/new.tsx`, `app/meals/new.tsx`, `src/components/day-log/DayLogList.tsx`, `src/components/meals/MealList.tsx`, `src/components/quick-add/QuickAddGrid.tsx`, `src/components/quick-add/UndoToast.tsx`, `src/components/settings/TargetsGroup.tsx`, `src/components/today/WeightChip.tsx`</sub>
