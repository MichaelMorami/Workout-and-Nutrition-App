...
### `app/meals/index.tsx`  <sub>45 lines</sub>
...
### `src/components/food-form/FoodForm.tsx`  <sub>303 lines</sub>
...
### `src/components/food-list/FoodList.tsx`  <sub>146 lines</sub>
...
### `src/components/meals/MealList.tsx`  <sub>181 lines</sub>
...
<sub>used by: `app/meals/index.tsx`, `app/meals/new.tsx`</sub>

### `src/components/meals/meal-candidate.ts`  <sub>22 lines</sub>

- `function candidateForMeal(meal: MealSummary): MealCandidate`

<sub>used by: `src/components/meals/MealList.tsx`</sub>
...
### `src/components/search/SearchSheet.tsx`  <sub>746 lines</sub>
...
<sub>used by: `app/(tabs)/index.tsx`, `app/(tabs)/settings.tsx`, `app/foods/[id].tsx`, `app/foods/index.tsx`, `app/foods/new.tsx`, `app/meals/index.tsx`, `app/meals/new.tsx`, `src/components/day-log/DayLogList.tsx`, `src/components/quick-add/QuickAddGrid.tsx`, `src/components/quick-add/UndoToast.tsx`, `src/components/today/WeightChip.tsx`</sub>
...
<sub>used by: `app/(tabs)/_layout.tsx`, `app/(tabs)/index.tsx`, `app/(tabs)/settings.tsx`, `app/_layout.tsx`, `app/foods/[id].tsx`, `app/foods/index.tsx`, `app/foods/new.tsx`, `app/meals/index.tsx`, `app/meals/new.tsx`, `src/components/day-log/DayLogList.tsx`, `src/components/quick-add/QuickAddGrid.tsx`, `src/components/quick-add/UndoToast.tsx`, `src/components/today/WeightChip.tsx`</sub>
...
### `src/sync/contract/sql.ts`  <sub>648 lines</sub>
