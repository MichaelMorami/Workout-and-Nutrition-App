...
### `app/(tabs)/index.tsx`  <sub>44 lines</sub>
...
<sub>used by: `src/components/db/DbProvider.tsx`, `src/components/db/db-context.ts`, `src/components/quick-add/QuickAddGrid.tsx`, `src/components/quick-add/QuickAddTile.tsx`, `src/hooks/deviceWhen.ts`, `src/hooks/useDb.ts`</sub>
...
<sub>used by: `app/(tabs)/_layout.tsx`, `app/(tabs)/index.tsx`, `app/_layout.tsx`, `src/components/quick-add/QuickAddGrid.tsx`</sub>
