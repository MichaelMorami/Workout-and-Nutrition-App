...
### `src/components/quick-add/QuickAddGrid.tsx`  <sub>172 lines</sub>

- `function QuickAddGrid({ onLogged, locale, testID = 'quick-add-grid' }: QuickAddGridProps): import("react").JSX.Element`
...
### `src/components/quick-add/QuickAddTile.tsx`  <sub>213 lines</sub>

- `function QuickAddTile({ candidate, onLog, theme, locale, testID = 'quick-add-tile' }: QuickAddTileProps): import("react").JSX.Element`
...
### `src/components/quick-add/index.ts`  <sub>3 lines</sub>
...
<sub>used by: `app/(tabs)/index.tsx`, `src/components/db/DbProvider.tsx`, `src/components/db/db-context.ts`, `src/components/quick-add/QuickAddGrid.tsx`, `src/components/quick-add/QuickAddTile.tsx`, `src/components/today/WeightChip.tsx`, `src/hooks/deviceWhen.ts`, `src/hooks/useDb.ts`</sub>
...
<sub>used by: `src/components/quick-add/QuickAddTile.tsx`</sub>
...
<sub>used by: `app/(tabs)/_layout.tsx`, `app/(tabs)/index.tsx`, `app/_layout.tsx`, `src/components/charts/ProgressArc.tsx`, `src/components/quick-add/QuickAddGrid.tsx`, `src/components/quick-add/QuickAddTile.tsx`, `src/components/theme/ThemeProvider.tsx`, `src/components/theme/font-assets.ts`, `src/components/theme/theme-context.ts`, `src/components/today/TodayHeader.tsx`, `src/components/today/WeightChip.tsx`, `src/hooks/useHapticFeedback.ts`, `src/hooks/useTheme.ts`, `src/store/theme-preference.ts`</sub>
