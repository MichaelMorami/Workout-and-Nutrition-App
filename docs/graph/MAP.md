...
### `src/components/food-form/FoodForm.tsx`  <sub>308 lines</sub>
...
### `src/components/food-form/Stepper.tsx`  <sub>158 lines</sub>
...
### `src/components/meals/meal-candidate.ts`  <sub>22 lines</sub>
...
### `src/sync/contract/sql.ts`  <sub>1169 lines</sub>
...
### `src/theme/tokens.ts`  <sub>1419 lines</sub>
